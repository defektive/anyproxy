    ...
    */
    ...
    co(fetchReqData)
      ...
      .then(co.wrap(function *() {
        ...
        const userModifiedInfo = (yield userRule.beforeSendRequest(Object.assign({resourceInfoId}, requestDetail))) || {};
        ...
        try {
          resourceInfo.userModifiedInfo = userModifiedInfo;
          recorder && recorder.updateRecord(resourceInfoId, resourceInfo);
        } catch (e) { }
        return finalReqDetail;
      }))

      // invoke Intercept hook
      .then(co.wrap(function *() {
        const ffff = (requestDetail) => {
          return new Promise((resolve, reject) => {
        ...
        const userModifiedInfo = (yield ffff(Object.assign({resourceInfoId}, requestDetail))) || {};
        const finalReqDetail = {};
        ['protocol', 'requestOptions', 'requestData', 'response'].map((key) => {
          finalReqDetail[key] = userModifiedInfo[key] || requestDetail[key]
        });
